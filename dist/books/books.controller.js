...
const borrows_service_1 = require("../borrows/borrows.service");
let BooksController = class BooksController {
    constructor(booksService, borrowsService) {
    ...
    findAll(genre, author, search, page, limit) {
...
__decorate([
    (0, common_1.Get)(':id/borrows'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], BooksController.prototype, "findBorrows", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
exports.BooksController = BooksController = __decorate([
    ...
    __metadata("design:paramtypes", [books_service_1.BooksService,
        borrows_service_1.BorrowsService])
], BooksController);
